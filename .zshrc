...
plugins=(git web-search zsh-autosuggestions zsh-autocomplete)
...
alias rofi-clean='rm -f ~/.cache/rofi*.druncache && echo "Cache do rofi limpo!"'

# Configuração do FZF para Zsh
