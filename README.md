...
> [!IMPORTANT]
> Regardless of whether you choose Hyprland, MangoWM, or Niri, the `random-wallpaper.sh` will generate `current_wallpaper.png` inside `~/.cache`. After that, use `SUPER + G` to execute `sequencia.sh`, which will adjust the colors.
