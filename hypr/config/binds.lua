...
hl.bind("SUPER + Y", hl.dsp.exec_cmd("kitty --class elio -e elio"))
hl.bind("SUPER + P", hl.dsp.exec_cmd("kitty -e nmtui"))
hl.bind("SUPER + SHIFT + A", hl.dsp.exec_cmd("kitty -e bluetui"))
...
hl.bind("SUPER + A", hl.dsp.exec_cmd(scripts .. "/hyprkeys.sh"))
...
hl.bind("SUPER + R", hl.dsp.exec_cmd(scripts .. "/refreshWaybar.sh"))
hl.bind("SUPER + S", hl.dsp.exec_cmd(scripts .. "/calendar.sh"))
hl.bind("SUPER + H", hl.dsp.exec_cmd(scripts .. "/random-wallpaper.sh"))
hl.bind("SUPER + Z", hl.dsp.exec_cmd(scripts .. "/take-screenshot.sh"))
hl.bind("SUPER + V", hl.dsp.exec_cmd(scripts .. "/clipboard_toggle.sh"))
hl.bind("SUPER + SHIFT + G", hl.dsp.exec_cmd(scripts .. "/screenrecord.sh"))
hl.bind("SUPER + SHIFT + B", hl.dsp.exec_cmd(scripts .. "/dashboard_toggle.sh"))
